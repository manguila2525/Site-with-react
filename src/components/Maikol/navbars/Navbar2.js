...
export default class Navbar2 extends Component {
    render() {
        ...
        //     </div>
        //   </nav>
        <nav className="flex items-center flex-wrap justify-between px-2 py-4 bg-teal-400">
            <div className="flex items-center flex-shrink-0 ml-6 border text-white text-center">
    ...
    transition ease-in-outduration-500">Download</a>
              </div>
            </div>
